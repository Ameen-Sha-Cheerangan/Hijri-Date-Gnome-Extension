...
const HijriDateIndicator = GObject.registerClass(
    class HijriDateIndicator extends PanelMenu.Button {
        _init(extensionObject) {
            ...
            const signalIds = ['date-adjustment', 'mycolor', 'latitude', 'longitude', 'numbering-locale'];
        ...
        _updateDate() {
            ...
            const numberingPref = this._settings.get_string('numbering-locale');
            const sys = (numberingPref === 'arabic') ? 'arab' : 'latn';
